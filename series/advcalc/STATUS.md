...
**狀態：E00–E21 已上傳（私人）。
第 0 章與第 1 章完結，第 2 章做到第 3 節的前半。
下一集 E22 接第 2 章第 3 節的後半（書頁 83–88）：零化子、伴隨算子 T*、
定理 3.3 到 3.5、dyad，以及自然性的交換圖。**
...
第 2 章目前：§1 用 E18–E19（71–77）、§2 用 E20（77–81）、§3 用 E21–E22（81–88）。
到這裡為止的實際集數都與 OUTLINE 的預估相符。
§3 的切法是照著書自己的分節標題切的：E21 收在「第二共軛空間」講完（81–83），
E22 從「零化子」起（83–88）。自然性那張交換圖雖然講的是 E21 的 V ≅ V**，
但它要用到 T*，所以只能留在 E22。
