...
**狀態：E00–E26 已上傳（私人）。
第 0 章與第 1 章完結，第 2 章第 1 到第 5 節完結。
下一集 E27 接第 2 章第 6 節「矩陣計算」（書頁 102–111），OUTLINE 排 E27–E28 兩集。**
...
§4 用 E23–E25（88–96）、§5 用 E26（99–101）。
...
- **英文字幕的 4 行上限要在寫稿當下就用 `textwrap` 實算，不能等到抽幀**。E22 初稿 11 拍裡有
  10 拍超過（最長 435 字元 / 7 行），全部重寫才壓下來。**順帶查出 E21 有 5 拍是 5 行**
  （beat 0、3、5、10 與另一拍，283–316 字元）——5 行字幕的頂端會到 y ≈ −1.7，
  而這兩集的最低一排說明字都放在 y = −1.78，所以 E21 那幾拍的字幕很可能壓在說明字上。
  E21 已上傳未動；要修就得重渲染重傳。**新集數一律先跑
